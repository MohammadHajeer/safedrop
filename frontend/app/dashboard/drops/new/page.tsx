    ...
    <div className="space-y-7">
      <header>
        ...
        <p className="mt-2 max-w-2xl leading-7 text-muted-foreground">
          Build a temporary message with the limits that make sense for this
          share.
        </p>
      </header>
        ...
        <aside className="space-y-4 xl:sticky xl:top-10">
          ...
          <Card className="gap-4 p-5 shadow-none ring-border">
            <div className="flex gap-3">
              ...
              <div>
                <h2 className="font-semibold">Direct uploads</h2>
                <p className="mt-1 text-sm leading-6 text-muted-foreground">
                  File bytes travel from this browser to private object storage,
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm leading-6 text-muted-foreground">
                  Every Drop ends when its time or view limit is reached.
                </p>
              </div>
            </div>
          </Card>
